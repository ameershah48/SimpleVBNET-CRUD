...
Partial Public Class testDataSet
    ...
    Partial Public Class tableDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddtableRow(ByVal name As String, ByVal phone As String) As tableRow
...
Namespace testDataSetTableAdapters
    ...
    Partial Public Class tableTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[table] WHERE (([id] = @Original_id) AND ((@IsNull_name = 1 AND"& _ 
                " [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_phone = 1 AND [phon"& _ 
                "e] IS NULL) OR ([phone] = @Original_phone)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[table] ([name], [phone]) VALUES (@name, @phone);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT id, n"& _ 
                "ame, phone FROM [table] WHERE (id = SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[table] SET [name] = @name, [phone] = @phone WHERE (([id] = @Origina"& _ 
                "l_id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) A"& _ 
                "ND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"S"& _ 
                "ELECT id, name, phone FROM [table] WHERE (id = @id)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.crud.My.MySettings.Default.testConnectionString1
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT id, name, phone FROM dbo.[table]"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As testDataSet.tableDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As testDataSet.tableDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As testDataSet.tableDataTable = New testDataSet.tableDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As testDataSet.tableDataTable) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal name As String, ByVal phone As String, ByVal Original_id As Integer, ByVal Original_name As String, ByVal Original_phone As String, ByVal id As Integer) As Integer
            If (name Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal name As String, ByVal phone As String, ByVal Original_id As Integer, ByVal Original_name As String, ByVal Original_phone As String) As Integer
            Return Me.Update(name, phone, Original_id, Original_name, Original_phone, Original_id)
        End Function
    End Class
